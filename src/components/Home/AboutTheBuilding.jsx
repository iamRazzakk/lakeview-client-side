...
const AboutTheBuilding = () => {
    ...
    return (
        <div className='font-Poppins md:flex gap-4 text-black md:mt-32 mt-10 p-6'>
            <div  data-aos="fade-right" className="flex-1 md:p-12">
                <h1 data-aos="fade-right" className=" text-2xl md:text-5xl md:mb-8">
                    Book A Luxury Apartment in Islamabad
                </h1>
                <h5 data-aos="fade-right" className='text-base font-bold md:mb-3'>
                ...
                <div  className='space-y-4'>
                    ...
                    <li data-aos="fade-right">It will spread over an area of 860,000 sq.ft., including over 14,000 sq.ft. area planned for gym and 4 floors reserved for car parking.</li>
                    <li data-aos="fade-right">
            ...
            <div className="flex-1">
                <img data-aos="fade-left" className='p-10 rounded-tl-full' src={locaionImg} alt="" />
            </div>
        </div>
    );
};
