        ...
        <div className='md:mt-32 mt-10 p-6'>
            <div className="md:flex">
                ...
                <div data-aos="fade-right" className="flex-1 space-y-3 md:p-16">
                    ...
                    <Link to='contact'>
                        <button className='border border-black lg:mt-2 bg-black text-white px-4 py-2 rounded flex justify-center items-center hover:bg-gray-600 hover:text-white'>About Us</button>
                    </Link>
                </div>
            </div>
